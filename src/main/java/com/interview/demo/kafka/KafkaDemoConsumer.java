...
public class KafkaDemoConsumer {
    ...
    public String executar() {
		...
		props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, "org.apache.kafka.common.deserialization.StringSerializer"); 
		props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "org.apache.kafka.common.deserialization.StringSerializer");
